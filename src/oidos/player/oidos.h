...
extern "C" {
	...
	void CALL_CONVENTION Oidos_FillRandomData();
	...
	void CALL_CONVENTION Oidos_GenerateMusic();

	// Play the music
	void CALL_CONVENTION Oidos_StartMusic();
	...
	float CALL_CONVENTION Oidos_GetPosition();
