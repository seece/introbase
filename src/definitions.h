...
/*
	...
	#define MAX_SAMPLES (44100*30) // TODO set this to a correct value
	...
	{
		(LPSTR)Oidos_MusicBuffer, MAX_SAMPLES * sizeof(SAMPLE_TYPE) * 2, 0, 0, 0, 0, 0, 0
	};
...
// > The compiler injects this 'useless' symbol to cause a floating support .obj to get loaded from the crt.
